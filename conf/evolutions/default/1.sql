...
alter table parent add constraint fk_parent_createdBy_2 foreign key (created_by_email) references user (email) on delete restrict on update restrict;
create index ix_parent_createdBy_2 on parent (created_by_email);
